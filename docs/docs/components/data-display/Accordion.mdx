...
The `AccordionPanel` component is a composition of the [Collapse](../transitions/Collapse) component. Therefore, all properties related to the [Collapse](../transitions/Collapse) component can be passed to the `AccordionPanel` component, in addition to the properties listed below.

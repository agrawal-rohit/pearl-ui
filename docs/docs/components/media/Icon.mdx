...
The `Icon` component is a versatile tool for adding [Expo Icons](https://icons.expo.fyi/) to your application. It offers customization options through the use of [style props](../../overview/core-features/style-props).
...
The `Icon` component supports animation properties from the [Moti](https://moti.fyi/) library, enabling the creation of dynamic and interactive UI elements. The [useMotiWithStyleProps](../../utils/hooks/useMotiWithStyleProps) hook from the Moti library is used to manage these animation properties.

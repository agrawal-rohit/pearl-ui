...
| Prop              | Stylesheet property | Type          |
| ----------------- | ------------------- | ------------- |
| `transform`       | `transform`         | <t>array</t>  |
| `transformMatrix` | `transformMatrix`   | <t>array</t>  |
| `rotation`        | `rotation`          | <t>number</t> |
| `scaleX`          | `scaleX`            | <t>number</t> |
| `scaleY`          | `scaleY`            | <t>number</t> |
| `translateX`      | `translateX`        | <t>number</t> |
| `translateY`      | `translateY`        | <t>number</t> |

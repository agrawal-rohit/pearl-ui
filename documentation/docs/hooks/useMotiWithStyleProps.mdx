...
The `useMotiWithStyleProps` is a powerful custom hook provided by Pearl UI, designed to transform [Moti](https://moti.fyi/) configurations written using [style props](../core-features/style-props) into a format suitable for creating dynamic animations in your React Native components.
...
- `exitTransition`: This prop lets you define the type of transition that occurs when the component unmounts.

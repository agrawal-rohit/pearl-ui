...
You can access the active color mode using the [useTheme](../hooks/useTheme) hook.
...
The [useTheme](../hooks/useTheme) hook provides the following functions to change the active color mode.
...
Pearl UI also offers the [useColorModeValue](../hooks/useColorModeValue) hook that achieves the same result as [the object syntax](#object-syntax).

Here's how you can re-write the example above using the [useColorModeValue](../hooks/useColorModeValue) hook:

...
The `size` prop can be used to adjust the size of the avatar. The available sizes are <t>"s"</t>, <t>"m"</t>, <t>"l"</t>, and <t>"xl"</t> in the [default component configuration](https://github.com/agrawal-rohit/pearl-ui/blob/main/src/components/molecules/avatar/avatar.config.ts).
...
| `spacing`                  | No       | <t>PearlTheme["spacing"]</t>                    |                                     | The spacing between the avatars.                                                                                        |

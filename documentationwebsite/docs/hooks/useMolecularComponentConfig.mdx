...
| `targetKeyForAdditionalStyleProps` | false    | <t>string \| undefined</t>                                       |                                         | The part where the style props passed to the component instance should be reflected. If undefined, the style props are passed to the first part as specified in the config                       |
| `targetKeyForNativeProps`          | false    | <t>string \| undefined</t>                                       |                                         | The part where other native props (non-style props) passed to the component instance should be reflected. If undefined, the native props are passed to the first part as specified in the config |

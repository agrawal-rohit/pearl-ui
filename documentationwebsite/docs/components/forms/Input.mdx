...
| placeholderTextColor   | false    | <t>PearlTheme.palette \| ColorModeColor</t>    | `"neutral.500"` | Custom color of the placeholder text string.                                  |
| selectionColor         | false    | <t>PearlTheme.palette \| ColorModeColor</t>    | `"primary.500"` | Custom color of the highlight and cursor color.                               |

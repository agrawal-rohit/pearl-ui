...
The `size` prop can be used to adjust the size of the avatar. The available sizes are <t>"s"</t>, <t>"m"</t>, <t>"l"</t>, and <t>"xl"</t> in the [default theme](#default-component-config).

...
Use the `size` prop to change the size of the avatar. You can set the value to the keys available in <t>theme.components.Avatar["sizes"]</t>, which are <t>"s"</t>, <t>"m"</t>, <t>"l"</t>, and <t>"xl"</t> in the [default theme](#default-component-style).
...
The Avatar component also supports a [variety of style props](#supported-style-props) which can be used to override the pre-defined component style in the theme. Manual style props passed into the component have a higher precedance than the [default component style](#default-component-style).
...
Avatar composes the [Image](./Image) component, you can pass all [Image](./Image) props to `Avatar`.
